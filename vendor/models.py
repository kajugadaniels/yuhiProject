...
class Vendor(models.Model):
    ...
    vid = models.UUIDField(default=shortuuid.uuid, editable=False, unique=True)
    ...
    image = models.ImageField(upload_to=use_directory_path, null=True, default="vendor.jpg")
